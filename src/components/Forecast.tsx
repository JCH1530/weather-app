...
const Forecast = ({ forecastData, handleBackClick }: ForecastProps) => {
  const today = forecastData.list[0];

  return (
    <div className="w-full md:max-w-[500px] md:py-10 md:px-10 lg:px-24 h-full lg:h-auto bg-white bg-opacity-20 backdrop-blur-ls rounded drop-shadow-lg py-10 my-10">
      <button
        onClick={handleBackClick}
        className="bg-blue-400 text-white px-4 py-2 rounded-br-lg hover:bg-blue-500 absolute top-0 left-0"
      >
        Back
      </button>
